...
# Demonstration script for TLS Traffic Capture Tool

echo "=== TLS Traffic Capture Tool Demonstration ==="
echo ""
...
ls -la simple_tls_capture.bpf.o tls_capture
...
timeout 10s ./tls_capture -i lo -f simple_tls_capture.bpf.o || true
